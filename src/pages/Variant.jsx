    ...
    return (
      <Shell>
        ...
        <div className="mt-8 flex gap-3">
          <button onClick={start} className="flex-1 bg-lime-400 hover:bg-lime-500 text-slate-900 font-semibold py-3 rounded-xl transition-colors">Новый вариант</button>
